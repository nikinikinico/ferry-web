    ...
    <el-row :gutter="12">
      ...
      >
        <chart-card
          ...
          @click.native="toTicketList('/process/all')"
        >
          <!-- <el-tooltip
            slot="action"
            class="item"
      ...
      >
        <chart-card
          :title="$t('我创建的')"
          :total="dashboardValue.count.my_create"
          style="cursor: pointer"
          @click.native="toTicketList('/process/my-create')"
        >
          <!-- <el-tooltip
            slot="action"
            class="item"
      ...
      >
        <chart-card
          :title="$t('我相关的')"
          :total="dashboardValue.count.related"
          style="cursor: pointer"
          @click.native="toTicketList('/process/related')"
        >
          <!-- <el-tooltip
            slot="action"
            class="item"
      ...
      >
        <chart-card
          :title="$t('我的待办')"
          :total="dashboardValue.count.upcoming"
          style="cursor: pointer"
          @click.native="toTicketList('/process/upcoming')"
        >
          <!-- <el-tooltip
            slot="action"
            class="item"
